...
private void tampilkanDataStok() {
    try {
        ...
        String sql = "SELECT kode_barang, nama_barang, kategori, harga_beli, harga_jual, stok FROM barang";
...
private void clearForm() {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            if (rs.next()){
                ...
                jTextField2.setText(rs.getString("harga_jual"));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try{
            ...
            jTextField5.setText(String.valueOf(harga*jumlah));
        }catch (Exception e){
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        try {
            ...
            String update = "UPDATE barang SET stok = stok - ? WHERE kode_barang = ?";
