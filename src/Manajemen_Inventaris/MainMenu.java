...
private javax.swing.JButton btnTransaksiPenjualan;
    ...
    /**
     * Creates new form IMNSS_Inventory
     */
...
private void setHakAkses(){
    if(role.equalsIgnoreCase("kasir")){
        System.out.println("Akses untuk kasir");
    }else if(role.equalsIgnoreCase("crew")){
        System.out.println("Akses untuk crew");
    }
}  
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Manajemen Inventaris IMNSS ");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MainMenu("kasir").setVisible(true);
            }
        });
    }
